...
public class AES256CCM extends Signcrypter<SecretKey, SecretKey> {
    public static final String ALGORITHM_IDENTIFIER = "AES/CCM/NoPadding";
    public static final int KEY_LENGTH = 256;
    public static final int TAG_LENGTH = 128;
    public static final int INITIALIZATION_VECTOR_BYTE = 13;
